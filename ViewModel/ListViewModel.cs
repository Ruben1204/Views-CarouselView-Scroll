    ...
    public class ListViewModel :INotifyPropertyChanged
    {
        ...
        public ListViewModel()
        {
            Robots = new List<Robot>
            {
                ...
                new Robot {Nombre = "Robot 2", Imagen = "dotnet_bot.png", Peso = 10.5, Details="Este Robot se llama dotnet_bot y es la imagen visual de NETMAUI"},
                ...
                new Robot {Nombre = "Robot 4", Imagen = "dotnet_bot.png", Peso = 25.5, Details="Este Robot se llama dotnet_bot y es la imagen visual de NETMAUI"},
                ...
                new Robot {Nombre = "Robot 7", Imagen = "dotnet_bot.png", Peso = 25.5, Details = "Este Robot se llama dotnet_bot y es la imagen visual de NETMAUI"},
                ...
                new Robot {Nombre = "Robot 9", Imagen = "dotnet_bot.png", Peso = 20.5, Details = "Este Robot se llama dotnet_bot y es la imagen visual de NETMAUI"},
